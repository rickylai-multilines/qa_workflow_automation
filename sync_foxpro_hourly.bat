...
set SOMAIN_JSON=%PROJECT_DIR%\foxpro_somain_export.json
set SODETAIL_JSON=%PROJECT_DIR%\foxpro_sodetail_export.json
set LOG_FILE=%PROJECT_DIR%\sync_foxpro_hourly.log
