...
FIELD_MAP = {
    ...
    'adate': 'mod_time',
    'extradate1': 'date1',
    'extradate2': 'audit_exp_date',
    'extradate3': 'date3',
    'homepage': 'homepage',
    'email1': 'contact_email1',
    'email2': 'contact_email2',
    'email3': 'contact_email3',
    'audit': 'audit_pass_time',
}
...
class Command(BaseCommand):
    help = "Import SUPPLIER JSON export into PostgreSQL Supplier table."
    ...
    def handle(self, *args, **options):
        ...
        for row in rows:
            ...
            audit_time, audit_by = _split_user_datetime(row.get('audit'))
            for source_field, target_field in FIELD_MAP.items():
                ...
                if target_field == 'mod_time':
                    value = mod_time
                if target_field == 'audit_pass_time':
                    value = audit_time
            ...
            if audit_by:
                mapped['audit_pass_by'] = _sanitize_text(audit_by)

            supplier_code = _sanitize_text(mapped.pop('supplier_code', None))
            ...
            self.stdout.write(self.style.SUCCESS(f"Imported Supplier {obj.supplier_code}"))
