...
class SOMain(models.Model):
    ...
    sc_currency = models.CharField(max_length=10, null=True, blank=True, db_column='SCCurrency')
    sc_ex_rate = models.DecimalField(max_digits=11, decimal_places=6, null=True, blank=True, db_column='SCExRate')
    po_currency = models.CharField(max_length=10, null=True, blank=True, db_column='POCurrency')
    po_total_amount = models.DecimalField(max_digits=15, decimal_places=4, null=True, blank=True, db_column='POTotalAmount')
    inv_total_amount = models.DecimalField(max_digits=15, decimal_places=4, null=True, blank=True, db_column='InvTotalAmount')
    ...
    charge1_cur_rate = models.DecimalField(max_digits=11, decimal_places=6, null=True, blank=True, db_column='Charge1CurRate')
    ...
    charge2_cur_rate = models.DecimalField(max_digits=11, decimal_places=6, null=True, blank=True, db_column='Charge2CurRate')
    ...
    charge3_cur_rate = models.DecimalField(max_digits=11, decimal_places=6, null=True, blank=True, db_column='Charge3CurRate')
    ...
    charge4_cur_rate = models.DecimalField(max_digits=11, decimal_places=6, null=True, blank=True, db_column='Charge4CurRate')
